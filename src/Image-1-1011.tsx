...
export default function Video() {
  ...
  const videoUrl = "https://player.vimeo.com/video/1099195711?h=c2bcc922b6&background=1&autoplay=0&loop=1&muted=1&controls=0&sidedock=0&title=0&byline=0&portrait=0";
